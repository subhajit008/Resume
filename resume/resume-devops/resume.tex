...
%Highly motivated DevOps enthusiast seeking an entry-level role to leverage technical skills and passion for automation and continuous integration/delivery to contribute to the growth of an organization.
%As an early professional in the world of technology, my career journey is marked by a fervent passion for both DevOps and cybersecurity. These fields represent the epicenter of modern IT, where efficiency, innovation, and security converge.
% My ambition is to play a pivotal role in this dynamic landscape, contributing to organizations by optimizing their technology stacks and fortifying their digital fortresses.
...
%	\item \textbf{Catalog Assistant} - \textit{\textbf{Amazon India}} \hfill [July 2021--February 2023]\\
...
%	-Manage and update product catalogs for consumables, 3pp using Amazon's proprietary catalog management systems.\\
%	-Create and edit product listings, ensuring accuracy and completeness of product information, images, and pricing.\\
%	-Perform quality checks to identify and resolve data discrepancies, and work with cross-functional teams to ensure data integrity.\\
%	-Monitor product performance metrics and make recommendations for optimizing listings and improving customer experience.
%	-Collaborate with vendors and suppliers to gather and verify product information and resolve issues.
...
%--------------------------------------------------------------------------------------
\section{ Projects}%Academic AND Personal
...
\begin{itemize}
	...
	\item \textbf{Continuous Integration/Continuous Delivery (CI/CD):} Jenkins, Argo CD %  GitLab CI/CD,
%	\item \textbf{Scripting Languages: Python, Bash, PowerShell
	\item \textbf{Version Control:} Git
	
	\item \textbf{Operating Systems:} Windows and Linux
	
	\item \textbf{Programming Language} Python, SQL, Bash %, DAX , Arduino C, Julia
	
%	\item \textbf{Visualization softwares:} Power BI%, \LaTeX %, MATLAB, DiaLux, AutoCAD, LabView,  Tableau%,GIMP% OriginLab, GraphPad, ImageJ, Image Pro, Photoshop, CorelDraw, 
...
%	\item \textbf{Testing:} Selenium , Postman %Manual (Black Box) \& Automation (Selenium) , Postman
